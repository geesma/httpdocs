...
<div class="w-full mb-6 bg-white bg-center bg-cover border border-gray-100 rounded-lg shadow-md h-96"
    style="background-image: url('{{ asset('images/logo/' . $liga->name . '.jpg') }}')">
