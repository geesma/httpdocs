    ...
    <div class="relative flex items-center justify-between h-16">
      <div class="absolute inset-y-0 left-0 flex items-center lg:hidden">
        <button type="button" class="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
          ...
          <svg class="block w-6 h-6" id="mobile-menu-closed" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="false">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
          </svg>
          <svg class="hidden w-6 h-6" id="mobile-menu-opened" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div class="flex items-center justify-center flex-1 md:items-stretch lg:justify-start">
        <div class="flex items-center flex-shrink-0">
          <img class="block w-auto h-8 xl:hidden" src="{{ asset('images/logo/logo_lliga_rectoret_no_letters.svg') }}" alt="Familia Tipster">
          <img class="hidden w-auto h-8 xl:block" src="{{ asset('images/logo/logo_lliga_rectoret_no_font.svg') }}" alt="Familia Tipster">
        </div>
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 lg:static lg:inset-auto lg:ml-6 lg:pr-0">
        ...
        <div class="relative">
          <div>
            <button type="button" class="p-1 mx-1 text-gray-400 bg-gray-800 rounded-full hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="admin-menu-button" aria-expanded="false" aria-haspopup="true">
          ...
          <div id="admin-menu" class="absolute right-0 hidden w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none galoo-submenu" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
        ...
        <div class="relative ml-3">
          <div>
            <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              ...
              <img class="object-cover object-center w-8 h-8 rounded-full" src="{{ isset(session()->get("user")->image) ? asset(session()->get("user")->image) : asset('images/uploads/profiles/no_image/no_image.jpg') }}" alt="">
            </button>
          </div>
          <div id="user-menu" class="absolute right-0 hidden w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none galoo-submenu" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
